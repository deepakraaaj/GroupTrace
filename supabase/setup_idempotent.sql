  ...
  -- ─────────────────────────────────────────────
  -- FUNCTION: create_group (drop old versions first)
  -- ─────────────────────────────────────────────
  drop function if exists public.create_group(text, text, group_context);
  drop function if exists public.create_group(text, text, group_context, text);
  drop function if exists public.create_group(text, text, group_context, text, text);
  ...
  -- ─────────────────────────────────────────────
  -- FUNCTION: join_group_by_code (drop old versions first)
  -- ─────────────────────────────────────────────
  drop function if exists public.join_group_by_code(text, varchar(4));
  drop function if exists public.join_group_by_code(text, varchar(4), text);
  drop function if exists public.join_group_by_code(text, varchar(6));
  drop function if exists public.join_group_by_code(uuid, varchar(6));
  ...
  -- ─────────────────────────────────────────────
  -- FUNCTION: sync_location (drop old versions first)
  -- ─────────────────────────────────────────────
  drop function if exists public.sync_location(uuid, uuid);
  drop function if exists public.sync_location(uuid, text);
  drop function if exists public.sync_location(uuid, uuid, decimal, decimal);
  drop function if exists public.sync_location(uuid, text, decimal, decimal);
